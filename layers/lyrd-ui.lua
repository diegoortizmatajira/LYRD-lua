...
function L.settings()
	...
	commands.implement("*", {
		...
		{ cmd.LYRDScratchClipboard, ":ScratchClipboard" },
		{ cmd.LYRDScratchYankToClipboard, ":ScratchYankToClipboard" },
		{ cmd.LYRDScratchPasteFromClipboard, ":ScratchPasteFromClipboard" },

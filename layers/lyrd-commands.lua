...
L.cmd = {
	LYRDUnimplementedCommands = { ["*"] = commands.list_unimplemented, desc = "" },
	LYRDImplementedCommands = { ["*"] = commands.list_implemented, desc = "" },
	LYRDBufferNew = { ["*"] = ":enew", desc = "" },
	LYRDBufferSave = { ["*"] = ":w", desc = "" },
	LYRDBufferSaveAll = { ["*"] = ":wall", desc = "" },
	LYRDBufferClose = { ["*"] = ":bd", desc = "" },
	LYRDBufferForceClose = { ["*"] = ":bd!", desc = "" },
	LYRDBufferCloseAll = { ["*"] = ":bufdo bd", desc = "" },
	LYRDBufferForceCloseAll = { ["*"] = ":bufdo bd!", desc = "" },
	LYRDBufferFormat = { desc = "" },
	LYRDBufferJumpToLast = { ["*"] = ":b#", desc = "Jump to last buffer" },
	LYRDBufferNext = { ["*"] = ":bn", desc = "" },
	LYRDBufferPrev = { ["*"] = ":bp", desc = "Previous Buffer" },
	LYRDBufferSplitV = { ["*"] = ":vsplit", desc = "" },
	LYRDBufferSplitH = { ["*"] = ":split", desc = "" },
	LYRDBufferSetReadOnly = { ["*"] = ":setl readonly!", desc = "" },
	LYRDBufferCopy = { ["*"] = ':normal! ggVG"+y``', desc = "" },
	LYRDBufferPaste = { ["*"] = ':normal! ggdG"+P', desc = "" },
	LYRDBufferToggleWrap = { ["*"] = ":setlocal wrap!", desc = "" },
	LYRDWindowClose = { ["*"] = ":q", desc = "" },
	LYRDWindowCloseAll = { ["*"] = ":qa", desc = "" },
	LYRDWindowForceCloseAll = { ["*"] = ":qa!", desc = "" },
	LYRDViewHomePage = { desc = "" },
	LYRDViewRegisters = { desc = "" },
	LYRDViewLocationList = { desc = "" },
	LYRDViewQuickFixList = { ["*"] = ":cope", desc = "" },
	LYRDViewYankList = { desc = "" },
	LYRDViewFileTree = { desc = "" },
	LYRDViewFileExplorer = { desc = "" },
	LYRDPluginsInstall = { ["*"] = ":PackerInstall", desc = "" },
	LYRDPluginsUpdate = { ["*"] = ":PackerSync", desc = "" },
	LYRDPluginsClean = { ["*"] = ":PackerClean", desc = "" },
	LYRDTerminal = { ["*"] = ":terminal", desc = "" },
	...
	LYRDBreakLine = { ["*"] = ":s/[,(]/&\r/ge|:noh|:'[,']normal==", desc = "" },
	LYRDSmartCoder = { desc = "" },
}

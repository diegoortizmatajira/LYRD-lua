...
local L = {
	...
	cmd = {
		...
		LYRDCodeDecode = Command:new("Code: Decode selection", nil, icons.action.replace_text, true),
		LYRDCodeEncode = Command:new("Code: Encode selection", nil, icons.action.switch, true),
		...
		LYRDGitPatchCreateStaged = Command:new("Git Patch: Create from staged changes", nil, icons.git.diff),
		LYRDGitPatchCreateUnstaged = Command:new("Git Patch: Create from unstaged changes", nil, icons.git.diff),
		...
		LYRDSiteNewPage = Command:new("Site: New page", nil, icons.file.new),
		LYRDSiteNewArticle = Command:new("Site: New article", nil, icons.file.new),
		LYRDSiteBuild = Command:new("Site: Build", nil, icons.code.build),
		LYRDSiteServe = Command:new("Site: Serve", nil, icons.apps.server),
		LYRDSiteListDrafts = Command:new("Site: List drafts", nil, icons.other.report),
		...
		LYRDScratchClipboard = Command:new("Scratch: Open clipboard", nil, icons.file.scratch),
		LYRDScratchYankToClipboard = Command:new("Scratch: Yank selection to clipboard", nil, icons.action.copy, true),
		LYRDScratchPasteFromClipboard = Command:new("Scratch: Paste from clipboard", nil, icons.action.paste),

...
local L = {
	...
	cmd = {
		...
		LYRDCodeQuerySelection = Command:new("Query: Run selected query", nil, icons.code.run, true),
		...
		LYRDScanForSecrets = Command:new("Scan: Secrets in current workspace", nil, icons.other.secret),

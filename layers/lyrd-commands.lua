...
local L = {
	...
	cmd = {
		...
		LYRDBufferClearContent = Command:new("Clear buffer content", ":%d _", icons.action.clean),
		...
		LYRDCodeTooling = Command:new("Tooling", nil, icons.other.tools),
		...
		LYRDDevServerStart = Command:new("Start development server", nil, icons.action.start),
		LYRDDevServerStop = Command:new("Stop development server", nil, icons.action.stop),

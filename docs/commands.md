...
| `LYRDCodeGenerateHttpFromOpenApi`       | Generate HTTP files from OpenAPI spec       | `<Space>cgh`                                                     | `*`                                   |
...
| `LYRDCopyOnlyText`                      | Copy as plain text (strip Markdown)         | `gyt`<br>`<Space>my`                                             | `*`                                   |
| `LYRDCopyWorkingDirectory`              | Copy working directory                      | `gyw`<br>`<Space>epw`                                            | `*`                                   |
| `LYRDDatabaseBackup`                    | Database backup                             | `<Space>rb`                                                      | `*`                                   |
| `LYRDDatabaseOutput`                    | Database Output                             | `<Leader><Leader>b`                                              | `*`                                   |
| `LYRDDatabaseRestore`                   | Database restore                            | `<Space>rB`                                                      | `*`                                   |
...
| `LYRDGithubDashboard`                   | Toggle GitHub dashboard                     | `<Space>ghd`                                                     | `*`                                   |
...
| `LYRDRegexTest`                         | Regex: Test Regular expressions             | `<Space><SPACE>r`                                                | `*`                                   |
...
| `LYRDSiteBuild`                         | Site: Build                                 | `<Space>wb`                                                      | `*`                                   |
| `LYRDSiteListDrafts`                    | Site: List drafts                           | `<Space>wl`                                                      | `*`                                   |
| `LYRDSiteNewArticle`                    | Site: New article                           | `<Space>wa`                                                      | `*`                                   |
| `LYRDSiteNewPage`                       | Site: New page                              | `<Space>wn`                                                      | `*`                                   |
| `LYRDSiteServe`                         | Site: Serve                                 | `<Space>ws`                                                      | `*`                                   |
...
| `LYRDTasksRecoverTmux`                  | Recover tmux tasks for this workspace       | `<Space>rs`                                                      | `*`                                   |
...
- **Site Commands** (`LYRDSite*`): Static-site (Hugo) page/article/build/serve
  workflows
...
- `u` - User interface
- `v` - View operations
- `w` - Website (static-site) operations

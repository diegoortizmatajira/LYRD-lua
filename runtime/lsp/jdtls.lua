...
-- runtime java-common.lua discovers within [MIN,MAX], and only falls back
...
-- java-common.lua /usr/lib/jvm scan finds it before ever falling back to a
	...
	vim.notify(
		string.format(
			"jdtls: no Java runtime found in the supported range [%d,%d] "
				...
				.. "runtimes discovered by java-common.lua). Falling back to "
